...
export const ActionDropdown = ({ file }: { file: Models.Document }) => {
  ...
  // Handle modal state changes and cleanup
  useEffect(() => {
    if (!isModalOpen) {
  ...
  const renderDialogContent = () => {
    ...
    const getDescription = () => {
      switch (value) {
        case "rename":
          return "Enter a new name for the file";
        case "details":
          return "View detailed information about this file";
        case "share":
          return "Share this file with other users by entering their email addresses";
        case "delete":
    ...
    return (
      <DialogContent key={value} className="shad-dialog button">
  ...
  return (
    <Dialog open={isModalOpen} onOpenChange={handleModalOpenChange}>
      ...
      >
        <DropdownMenuTrigger className="shad-no-focus" asChild>
          <button
            type="button"
